...
public class WeekTwo {
    ...
    public static void main(String[] args) {
         ...
         * are circularly shifted by any number of positions; e.g., ACTGACG is a circular shift of TGACGAC,
         * and vice versa. Detecting this condition is important in the study of genomic sequences.
         * Desig an algorithm that checks whether two given strings s and t are circular shifts of one another.
         */
         ...
         * 
         * We could call the array on N-1 and return the respective item at that index.
         */

        /*
         * 1.3.19
         * Explain how you would create a method/function removeLast(), that removes the last node in a linked 
         * list whose first node is stored in the variable first. Making a drawing of what is going on is encouraged.
         * 
        ...
        /*
         * 1.3.20
         * Explain and draw how one could design a method/function delete() that takes an int argument 
         * k and deletes the k'th element in a linked list, if it exists.
         * 
         * remove(int k) {
         *  int i = 0;
         *  node n = first;
        ...
        /*
         * 1.3.21
         * Explain how one could desing a method find() that takes a linked list and a string key as arguments and 
         ...
         * (This question is also in the quiz, but necessary for the question below).
         ...
         * Describe how you can find and output the maximum key in the list. Assume that all keys
        ...
        /*
         * 1.3.24
         * Explain how you would design a method/function removeAfter() that takes a linked-list Node as argument and 
         * removes the node following the given one (and does nothing if the argument or the next field in the argument node is null).
         * 
        ...
        /*
         * 1.3.25
         * Explain how you would design a method/function insertAfter() that takes two linked-list nodes (n1 and n2) as arguments. 
         * Assume that n1 is in a list, and insert n2 immediately after n1. Do nothing if either argument is null.
         * 
         * insertAfter(n1, n2) {
         *      n2.next = n1.next
         *      n1.next = n2
        ...
        /*
         * 1.3.31
         * A doubly-linked list is a linked list, where each node contains a reference to the previous node in the list 
         * in addition to the reference to the next node. We define the nodes of this list to be of the class DoubleNode. 
         * Explain how the class DoubleNode differs from a regular Node class in a linked list, 
         * and make a drawing of a doubly-linked list data structure.
         * Next, describe how the following methods/functions work in a doubly-linkedlist: 
         * 
